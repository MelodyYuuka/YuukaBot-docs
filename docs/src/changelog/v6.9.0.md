...
- 新增 [云梦都相关](../function/touhou/yunmengdu.md) 内容
- 新增 [东方猜](../function/touhou/touhou_guess.md)
...
- 更新 [设定生成器系统](../function/play/shindanmaker.md)：在文本过长的时候会转成图片，新增 `我的颜文字`，`特殊能力`。`世间万物化为` 更名为 `万物化为`
...
- 更新 [语音功能](../function/play/voice.md)：加强了 `塔菲说` 和 `东雪莲说`，现在可以自动识别中文/英文/日文，加强 `油库里`、`宁宁说`、`爱瑠说`、`芳乃说`、`茉子说`、`丛雨说`、`小春说`、`七海说`，现在支持中文和日文，新增 `常轨脱离` 语音对象 `妃爱说`、`华乃说`、`亚澄说`、`诗樱说`、`天梨说`、`里说`、`广梦说`、`莉莉子说`，增强 `嘉然说` 现在可以说中日英文了
...
- 由于腾讯审核要求，在 `QQBot` 平台上关闭部分语音功能

## 更新时间线

### 2024-05-09

- 更新 [东方原曲点歌](../function/touhou/touhou_music.md) 和 [东方问答](../function/touhou/touhou_quiz.md)：原曲数据已更新到新专

### 2024-05-08

- 新增 [东方猜](../function/touhou/touhou_guess.md)
- 更新 [东方问答](../function/touhou/touhou_quiz.md)：添加了一道知识问答
