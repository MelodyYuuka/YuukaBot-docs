...
| :-----------------------------------: | :---: | :---: | :---: | :---: | :--------------------------------------: | ------------------------------------------------ |
| <div style="width: 50pt">QQ野生</div> |   ✅   |   ✅   |   ✅   |   ❌   | <div style="width: 70pt">🐝直接触发</div> | <div style="width: 140pt">支持几乎全部功能</div> |
...
|                        平台                        | 图片  | 语音  | 回复  | 按钮  |                 触发形式                 | 备注                                                                        |
| :------------------------------------------------: | :---: | :---: | :---: | :---: | :--------------------------------------: | --------------------------------------------------------------------------- |
| <div style="width: 50pt">大别野<br/>(米游社)</div> |   ✅   |   ❌   |   ✅   |   🟨   | <div style="width: 65pt">@需要艾特</div> | <div style="width: 140pt">适配大部分功能<br/>由于大别野下架而停止支持</div> |
