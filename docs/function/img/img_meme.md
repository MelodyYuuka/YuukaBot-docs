...
- 如果带前缀 `/` 或 [艾特](/about/glossary.md#%E8%89%BE%E7%89%B9)了机器人，则可无需完整参数，参数不完整时会提醒您缺失的参数，在后续补全参数即可
...
- [艾特](/about/glossary.md#%E8%89%BE%E7%89%B9)机器人或加前缀 `/` 则可省略部分参数，后续补全即可，参数不完整时也会返回提示信息
