...
- 重构 [一言](../function/play/hitokoto.md)

### 2024-05-01

- 优化 [东方原曲点歌](../function/touhou/touhou_music.md)

### 2024-04-28

- 更新 `/help` 在 `QQBot` 平台下的UI
- 更新 `/tips`：一些小贴士~
...
- 由于腾讯审核要求，因`“涉嫌赌博”`，`QQBot` 暂停骰子相关功能

### 2024-04-14

- 更新 [100%鲜橙汁](../function/query/orange_juice.md)：`橙汁查卡`，`橙汁抽卡`
- 对于 [QQ野生](../FAQ)： 适配了 [QQNT] 的新版图片策略，优化了使用体验
...
- 优化 [图片转链接](../function/img/img2url.md)：对于 `QQBot` 平台上的链接可用性
...
- 修复了重构后造成的一些网络问题
- 由于大别野即将于3月12日停止运营，在大别野（Villa）的 Bot 服务标记为 <Badge type="warning" text="已弃用" vertical="top" />
